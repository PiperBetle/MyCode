...
//	freopen(".out","w",stdout);
	...
	cin>>T;for(;T--;)switch(get<int>()){
		case 1:cin>>p>>s;p-=d;a.insert(p,s.c_str());b[++l]=a;break;
		case 2:cin>>p>>c;p-=d;c-=d;a.erase(p-1,c);b[++l]=a;break;
		case 3:cin>>v>>p>>c;v-=d;p-=d;c-=d;auto ans=b[v].substr(p-1,c);d+=int(std::count(all(ans),'c'));cout<<ans<<'\n';break;
	}
	return 0;
}