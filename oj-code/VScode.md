...
"code-runner.executorMap": {
	"cpp": "cls && cd $dir && g++ \"$fileName\" -o VScodeRunner -std=c++20 -Wl,--stack=1048576 -O2 -Wall -Wextra -Wpedantic -Wshadow -Wconversion && VScodeRunner.exe",
...
```json
"cpp": "cls && cd $dir && g++ \"$fileName\" -o \"$fileNameWithoutExt\" && -std=c++20 -Wl,--stack=1048576 -O2 -Wall -Wextra -Wpedantic -Wshadow -Wconversion $dir\"$fileNameWithoutExt\"",
```
...
```json
"code-runner.executorMap": {
	"cpp": "cls && cd $dir && g++ \"$fileName\" -o VScodeRunner -std=c++20 -Wl,--stack=1048576 -O2 -Wall -Wextra -Wpedantic -Wshadow -Wconversion && $workspaceRoot\\IcePrint \"compile okey, my master ~\" && VScodeRunner",
},
```
...
```json
{
	...
	"editor.fontFamily": "Fira Code",
	// "editor.fontFamily": "JetBrains Mono", //值得尝试的字体
	// "editor.fontFamily": "Ubuntu Mono", //值得尝试的字体
	...
	"backgroundCover.imagePath": "f:\\soft\\.vscode\\photo\\93928992_p0_master1200.jpg",
	"backgroundCover.opacity": 0.0,
