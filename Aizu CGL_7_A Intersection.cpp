...
int get_op(const double &x){if(fabs(x)<eps)return 0;return fabs(x)/x;}
struct vector{
	double x,y;
...
//	freopen(".out","w",stdout);
	...
	circle o1,o2;
	cin>>o1>>o2;
	if(get_op(dis(o1.p,o2.p)-o1.r-o2.r)>0)return cout<<4<<'\n',0;
	if(get_op(dis(o1.p,o2.p)-o1.r-o2.r)==0)return cout<<3<<'\n',0;
	if(get_op(dis(o1.p,o2.p)-fabs(o1.r-o2.r))>0)return cout<<2<<'\n',0;
	if(get_op(dis(o1.p,o2.p)-fabs(o1.r-o2.r))==0)return cout<<1<<'\n',0;
	if(get_op(dis(o1.p,o2.p)-fabs(o1.r-o2.r))<0)return cout<<0<<'\n',0;
	return 0;
}