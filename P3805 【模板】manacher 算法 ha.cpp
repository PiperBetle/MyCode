...
constexpr int N=2.2e7+2,P=233;
unt pw[N],h1[N],h2[N];
unt get_h1(int l,int r){return h1[r]-h1[l-1]*pw[r-l+1];}
unt get_h2(int l,int r){return h2[l]-h2[r+1]*pw[r-l+1];}
int n,m;
bsc s,a="~|";
signed main(){
//	freopen(".in","r",stdin);
//	freopen(".out","w",stdout);
	...
	for(int i=1;i<=n;i++)while(m<i&&i+m<=n&&
		get_h1(i-m,i+m)==get_h2(i-m,i+m))m++;
	cout<<m-1;
	return 0;
}